...
CREATE TABLE Menu(
	RestaurantID INT,
	DishID INT,
	FOREIGN KEY (RestaurantID) REFERENCES Restaurants(RestaurantID),--This foreign key will take restaurantID from restaurants table
	FOREIGN KEY (DishID) REFERENCES Dishes(DishID), --Foreign key is used to contain whole menu	
